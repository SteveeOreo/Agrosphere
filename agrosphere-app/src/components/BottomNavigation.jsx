    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50 safe-area-pb">
      <div className="flex items-center justify-around py-2 px-2">
        ...
        >
          ...
          <span className="text-xs font-medium truncate">Market</span>
        </Link>

        {/* Notifications */}
        <Link
          to="/notifications"
          className={`flex flex-col items-center py-2 px-1 min-w-0 relative ${
        ...
        >
          ...
          <span className="text-xs font-medium truncate">Forum</span>
        </Link>
      </div>
    </nav>
  );
